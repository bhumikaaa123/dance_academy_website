...
<body>
    ...
    <div class="container-title">
        <h2>LATIN DANCE STYLE</h2>
    </div>

    <!-- Novelty or Fad Dance Styles -->
    <div class="card-container">
        <!-- Add cards for each dance style here -->
        <div class="card">
            <img src="bhuumika/rumba.jpg" class="card-img-top" alt="Rumba Dance">
            <div class="card-body">
                <h5 class="card-title">Rumba</h5>
                <p class="card-text">Romantic Cuban dance with slow,<br> expressive movements.</p>
                <a href="enroll_now.php" class="btn btn-primary mt-auto enroll-btn" data-dance-form="Dance Form Name">Enroll Now</a>
            </div>
        </div>
        <div class="card">
            <img src="bhuumika/salsa.jpg" class="card-img-top" alt="Salsa Dance">
            <div class="card-body">
                <h5 class="card-title">Salsa</h5>
                <p class="card-text">Energetic Latin dance with lively<br>footwork and smooth partner moves.</p>
                <a href="enroll_now.php" class="btn btn-primary mt-auto enroll-btn" data-dance-form="Dance Form Name">Enroll Now</a>
            </div>
        </div>
        <div class="card">
            <img src="bhuumika/chacha.jpg" class="card-img-top" alt="Cha-Cha Dance">
            <div class="card-body">
                <h5 class="card-title">Cha-Cha</h5>
                <p class="card-text">Fast-paced Latin dance with<br>syncopated rhythms and quick steps.</p>
                <a href="enroll_now.php" class="btn btn-primary mt-auto enroll-btn" data-dance-form="Dance Form Name">Enroll Now</a>
            </div>
        </div>
    </div>
